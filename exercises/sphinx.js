class Sphinx {
  ...
  collectRiddle(_riddle) {
    this.riddles.push(_riddle);
  ...
  attemptAnswer(_answer) {
    ...
    if (this.riddles.length == 0) {
      return `PSSSSSSS THIS HAS NEVER HAPPENED, HOW DID YOU KNOW THE ANSWER WAS \"${_answer}\"???`
